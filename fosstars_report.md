...
1.  [Suggest a security policy for the project](https://github.com/KristenLinek/ilax/security/policy)
...
241 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 241
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **0.0**, confidence is 6.67 (low), weight is 0.5 (medium)
